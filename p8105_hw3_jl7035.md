...
the number of men and women high school equivalent category, such that
there were 12 more male participants than female participants with a
high school equivalent education. Interestingly, more female
participants had more than high school education compared to men, but
only by a difference of +3.
...
Create reader-friendly table showing total number of rides in each
...
Figure that shows the impact of month, membership status, and bike type
on the distribution of ride duration
